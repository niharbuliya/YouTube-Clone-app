...
import com.example.youtubeplayer.R.string
import com.example.youtubeplayer.R.string.GOOGLE_API_KEY
import com.google.android.youtube.player.YouTubeBaseActivity
import com.google.android.youtube.player.YouTubeInitializationResult
import com.google.android.youtube.player.YouTubePlayer
import com.google.android.youtube.player.YouTubePlayerView

const val YOUTUBE_VIDEO_ID= "UtF6Jej8yb4"
...
//        layout.addView(button1)
        ...
        playerView.initialize(getString(GOOGLE_API_KEY), this)

    }

    override fun onInitializationSuccess(provider: YouTubePlayer.Provider?, youTubePlayer: YouTubePlayer?, wasRestored: Boolean) {
        Log.d(TAG,"onIntializationSuccess : provider is {$provider?.javaClass}")
        Log.d(TAG, "onIntializationSucces: youTubePlayer is ${youTubePlayer?.javaClass}")
